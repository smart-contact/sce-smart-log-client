...
Questa versione suppurta laravel >=5.6 e laravel <= 6.x
...
2. Una volta che le eventuali modifiche sono completate, mergiare il branch release creato al branch **1.x** (equivale al master per la versione 1).
...
## 2.x
Per la versione 2.x, che suppurta laravel dalla versione 7 in poi, seguire i stessi passaggi per la versione 1.x
sostituendo:
  `1.x` ➡️ `2.x`
